...
export default props => (
  <Accordion>
    <AccordionPanel title="Accordion Panel Title Here">
      <p>
        <Tag>This is a label</Tag>
        <Tag type={1}>This is a label</Tag>
        <Tag type={2}>This is a label</Tag>
        <Tag type={3}>This is a label</Tag>
        <Tag type={4}>This is a label</Tag>
      </p>
      <p>
